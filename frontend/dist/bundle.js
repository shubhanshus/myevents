...
var event_booking_form_1 = __webpack_require__(60);
var EventBookingFormContainer = /** @class */ (function (_super) {
    __extends(EventBookingFormContainer, _super);
    function EventBookingFormContainer(p) {
    ...
    EventBookingFormContainer.prototype.render = function () {
        var _this = this;
        ...
        if (this.state.state === "done") {
            return React.createElement("div", { className: "alert alert-success" }, "Booking successfully completed!");
        }
        return React.createElement(event_booking_form_1.EventBookingForm, { event: this.state.event, onSubmit: function (amount) { return _this.handleSubmit(amount); } });
    };
    EventBookingFormContainer.prototype.handleSubmit = function (seats) {
        var _this = this;
        var url = this.props.bookingServiceURL + "/events/" + this.props.eventID + "/bookings";
        var payload = { seats: seats };
        this.setState({
...
exports.EventBookingFormContainer = EventBookingFormContainer;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var event_list_1 = __webpack_require__(61);
...
var EventListContainer = /** @class */ (function (_super) {
    ...
    EventListContainer.prototype.handleEventBooked = function (e) {
        console.log("booking event...");
    };
    EventListContainer.prototype.render = function () {
        var _this = this;
        return React.createElement(loader_1.Loader, { loading: this.state.loading, message: "Loading events..." },
            React.createElement(event_list_1.EventList, { events: this.state.events, onEventBooked: function (e) { return _this.handleEventBooked(e); } }));
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createHashHistory__ = __webpack_require__(31);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var form_row_1 = __webpack_require__(63);
var EventBookingForm = /** @class */ (function (_super) {
    __extends(EventBookingForm, _super);
    ...
    EventBookingForm.prototype.handleNewAmount = function (event) {
        var newState = {
            selectedAmount: parseInt(event.target.value)
        };
        this.setState(newState);
    };
    EventBookingForm.prototype.render = function () {
        var _this = this;
        return React.createElement("div", null,
            ...
            React.createElement("form", { className: "form-horizontal" },
                React.createElement(form_row_1.FormRow, { label: "Event" },
                    React.createElement("p", { className: "form-control-static" }, this.props.event.Name)),
                React.createElement(form_row_1.FormRow, { label: "Number of tickets" },
                    React.createElement("select", { className: "form-control", value: this.state.selectedAmount, onChange: function (e) { return _this.handleNewAmount(e); } },
                        React.createElement("option", { value: "1" }, "1"),
                        React.createElement("option", { value: "2" }, "2"),
                        React.createElement("option", { value: "3" }, "3"),
                        React.createElement("option", { value: "4" }, "4"))),
                React.createElement(form_row_1.FormRow, null,
                    React.createElement("button", { className: "btn btn-primary", onClick: function () { return _this.props.onSubmit(_this.state.selectedAmount); } }, "Submit order"))));
    };
    return EventBookingForm;
}(React.Component));
exports.EventBookingForm = EventBookingForm;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var event_list_item_1 = __webpack_require__(62);
var EventList = /** @class */ (function (_super) {
    ...
    EventList.prototype.render = function () {
        ...
        var items = this.props.events.map(function (event) {
            return React.createElement(event_list_item_1.EventListItem, { key: event.ID, event: event, onBooked: function () { return _this.props.onEventBooked(event); } });
        });
...
var EventListItem = /** @class */ (function (_super) {
    ...
    EventListItem.prototype.render = function () {
        ...
        var locationName = this.props.event.Location ? this.props.event.Location.Name : "unknown";
        console.log(this.props.event);
        return React.createElement("tr", null,
            React.createElement("td", null, this.props.event.Name),
            React.createElement("td", null, locationName),
            React.createElement("td", null, start.toLocaleDateString()),
            React.createElement("td", null, end.toLocaleDateString()),
            React.createElement("td", null,
                React.createElement(react_router_dom_1.Link, { to: "/events/" + this.props.event.ID + "/book", className: "btn btn-primary" }, "Book now!")));
    };
...
var Loader = /** @class */ (function (_super) {
    ...
    Loader.prototype.render = function () {
        var msg = this.props.message || "Loading. Please wait...";
...
var react_router_dom_1 = __webpack_require__(8);
var event_list_container_1 = __webpack_require__(27);
var navigation_1 = __webpack_require__(28);
var event_booking_form_container_1 = __webpack_require__(26);
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        var eventList = function () { return React.createElement(event_list_container_1.EventListContainer, { eventServiceURL: "http://localhost:8181" }); };
        var eventBooking = function (_a) {
            var match = _a.match;
            return React.createElement(event_booking_form_container_1.EventBookingFormContainer, { eventID: match.params.id, eventServiceURL: "http://localhost:8181", bookingServiceURL: "http://localhost:8282" });
        };
        return React.createElement(react_router_dom_1.HashRouter, null,
            React.createElement("div", null,
                ...
                React.createElement("div", { className: "container" },
                    ...
                    React.createElement(react_router_dom_1.Route, { path: "/events/:id/book", component: eventBooking }))));
    };
    return App;
}(React.Component));
